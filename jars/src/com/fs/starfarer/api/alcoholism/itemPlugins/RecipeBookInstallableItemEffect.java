...
public class RecipeBookInstallableItemEffect extends BaseInstallableItemEffect {
    ...
    public void apply(Industry industry) {
        if (industry instanceof BaseIndustry) {
            ...
            List<Alcohol> alcoholList = getRecipeBookAlcohols(industry);
    ...
    public void unapply(Industry industry) {
        ...
        for (Alcohol alcohol : getRecipeBookAlcohols(industry)) {
    ...
    public List<Alcohol> getRecipeBookAlcohols(Industry industry) {
    ...
    protected void addItemDescriptionImpl(Industry industry, TooltipMakerAPI text, SpecialItemData data,
        ...
        if (data instanceof RecipeBookSpecialItemData) {
            ...
            for (Alcohol alcohol : recipeData.getAlcoholList()) {
